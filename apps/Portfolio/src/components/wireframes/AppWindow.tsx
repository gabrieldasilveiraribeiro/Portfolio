...
function AppWindow({
  ...
  return (
    <div
      role="presentation"
      className={clsx(
        'border-divider-light pointer-events-auto flex h-full w-full select-none flex-col overflow-hidden rounded-xl border bg-white',
        'dark:border-divider-dark dark:bg-[#0c1222]',
        { 'z-50': type === 'browser' } // Define um z-index alto para a janela do navegador
      )}
    >
      <div
        className={clsx(
